...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        buttons = [[InlineKeyboardButton("💥 Telegram Channel", url = "https://t.me/Anime_warrior_tamil"), InlineKeyboardButton("💬 Discussion group", url = "https://t.me/+E5gnW96seRliZDI1")],
            [InlineKeyboardButton("✨ ᴀʙᴏᴜᴛ ", callback_data = "about"), InlineKeyboardButton("😈 ᴏᴡɴᴇʀ ", url="https://t.me/tech_freak_tamil")]]
        if user_id in client.admins:
            buttons.insert(2, [InlineKeyboardButton("⛩️ ꜱᴇᴛᴛɪɴɢꜱ ⛩️", callback_data="settings")])
